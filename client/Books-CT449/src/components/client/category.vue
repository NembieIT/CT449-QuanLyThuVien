<template lang="">
    <div v-if="loaded" class="h-full w-full bg-gray p-5">
        <div class="w-full h-[15%] p-5 bg-white">
            <span>Phân loại</span>
        ...
        <div class="h-[85%] flex items-start justify-start gap-[5%] p-5 flex-wrap overflow-scroll bg-white">
            <div v-if="visibleTask.length > 0" v-for="(item, index) in visibleTask" :key="index"
                class="w-[40%] lg:w-[20%] h-[70%] bg-gray-500/40 rounded-2xl overflow-hidden cursor-pointer flex flex-col justify-between">
